...
public class MotorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        motorViewModel =
                ViewModelProviders.of(this).get(MotorViewModel.class);
        View root = inflater.inflate(R.layout.fragment_motor, container, false);
        final TextView textView = root.findViewById(R.id.text_motor);
        motorViewModel.getText().observe(this, new Observer<String>() {
            @Override
